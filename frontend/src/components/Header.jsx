...
import { LayoutDashboard, BookOpen, CheckCircle2, Calendar, Network, Zap, Sun, Moon } from 'lucide-react';

export default function Header({ currentView, onChangeView, onOpenCmd, isDark, onToggleTheme }) {
  return (
